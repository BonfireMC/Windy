...
public class WindyParticles {
    ...
    public static /*? neoforge || forge {*/Supplier</*?}*/SimpleParticleType/*? neoforge || forge {*/>/*?}*/ WIND = /*? fabric {*//*Registry.register(BuiltInRegistries.PARTICLE_TYPE, asResource("wind"), FabricParticleTypes.simple())*//*?} else {*/PARTICLE_TYPES.register("wind", () -> new SimpleParticleType(false))/*?}*/;
    public static /*? neoforge || forge {*/Supplier</*?}*/SimpleParticleType/*? neoforge || forge {*/>/*?}*/ STRONG_WIND = /*? fabric {*//*Registry.register(BuiltInRegistries.PARTICLE_TYPE, asResource("strong_wind"), FabricParticleTypes.simple())*//*?} else {*/PARTICLE_TYPES.register("strong_wind", () -> new SimpleParticleType(false))/*?}*/;
